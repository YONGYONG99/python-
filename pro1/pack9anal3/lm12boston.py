...
df=pd.read_csv('../testdata/housing.data', header=None, sep='\s+') # sep='\s+' -> 공백기준으로 구분
...
#  [9.14]
#  [4.03]]
# [24.  21.6 34.7]       ===> 4.98일때 24... 이걸로 학습 하자
...
plt.plot(x_fit, y_lin_fit, linestyle=':', label='linear fit(d=1), $R^2=%.2f$'%model_r2, c='b', lw=3) # $R^2=%.2f$ R스퀘어 값 소숫점 2자리까지
