...
# print(y) # [0 0 1 0 2 2 2 1 1 0] # 군집분석이므로 의미 없다.
...
print(x[pred == 1][:3])
print(x[pred == 2][:3])
print('controid(군집 중심점) : ', kmodel.cluster_centers_)
...
# K-Means에서 K를 정하는 것이 가장 중요한 문제 중 하나
# 방법1 : 계층적 군집으로 K값 유추
# 방법2 : 엘보우(elbow) 기법 - 클러스터 간 SSE의 차이를 이용
def elbow(x):
    sse = []
    for i in range(2, 11):
...
# https://cafe.daum.net/flowlife/SBU0/60
